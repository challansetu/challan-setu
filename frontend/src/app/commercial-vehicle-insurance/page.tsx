          ...
          <div className="relative z-10 bg-white rounded-t-3xl -mt-8">
            ...
            <div className="container-app max-w-5xl py-4">
              <p className="text-xs text-gray-400 leading-relaxed border border-gray-100 rounded-xl px-4 py-3 bg-gray-50">
                <strong>Disclosure:</strong> ChallanSetu earns a referral commission when you renew commercial vehicle insurance through our PolicyBazaar partner links. This does not affect your premium, prices are identical to buying directly. We only partner with IRDA-approved insurers.
              </p>
            </div>
