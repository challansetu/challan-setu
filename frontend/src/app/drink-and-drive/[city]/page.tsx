...
// Server wrapper around the client WhatsApp CTA, tagged with this page's location.
function CTAButton(props: { label: string; subtitle?: string; message: string; size?: 'sm' | 'md' | 'lg' }) {
  return <WhatsAppCtaButton {...props} location="drink_drive_city" />;
}
