...
// Server wrapper around the shared client WhatsApp CTA (fires whatsapp_click).
function CTAButton(props: { label: string; subtitle?: string; fullWidth?: boolean; size?: 'sm' | 'md' | 'lg' }) {
  return <WhatsAppCtaButton {...props} message={DND_WHATSAPP_MESSAGE} location="drink_and_drive_hub" />;
}
