...
const PAGE_TITLE = 'Bike Insurance Renewal from ₹1.3/day';
const PAGE_DESC =
  'Check bike insurance status free by registration number via VAHAN. Renew two-wheeler insurance from ₹1.3/day, compare 20+ insurers, theft cover.';
