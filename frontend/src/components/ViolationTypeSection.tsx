        ...
        <div className="container-app max-w-5xl">
          ...
          <div className="space-y-3 mb-6">
            {content.faqs.map((faq, i) => (
              <details
                key={i}
                className="group bg-white rounded-lg border border-gray-200 overflow-hidden hover:border-gray-300 transition-all hover:shadow-md"
              >
                <summary className="flex items-center justify-between cursor-pointer px-5 py-4 font-semibold text-gray-900 hover:bg-slate-50 transition-colors list-none">
                  <span className="text-base">{faq.q}</span>
                  <span
                    className="ml-4 text-gray-400 flex-shrink-0 group-open:rotate-45 transition-transform duration-300 text-xl leading-none font-light"
                    style={{ color: BRAND_YELLOW }}
                  >
                    +
                  </span>
                </summary>
                <div className="px-5 pb-4 pt-2 border-t border-gray-100 bg-slate-50/50">
