      ...
      <div className="container-app">
        ...
        <div className="relative rounded-2xl overflow-hidden bg-[#eeeeff] border border-primary-100 flex flex-row items-stretch h-[200px] sm:h-[220px]">
          ...
          <div className="flex-1 px-6 py-6 flex flex-col justify-between z-10">
            <div>
              <h3 className="text-base sm:text-lg font-bold text-gray-900 leading-snug mb-0.5">
                Police recovered<br />your vehicle?
              </h3>
              <p className="text-primary-600 font-bold text-sm sm:text-base">We'll get it back. Legally.</p>
            </div>

            <Link
              href="/recover-stolen-vehicle"
              className="inline-flex items-center gap-1.5 bg-primary-600 hover:bg-primary-700 text-white font-bold text-xs px-4 py-2 rounded-lg transition-colors w-fit"
            >
              Start Recovery
          ...
          <div className="absolute right-0 top-0 bottom-0 w-[60%]">
            <Image
              ...
              unoptimized
            />
            <div className="absolute inset-y-0 left-0 w-1/3 bg-gradient-to-r from-[#eeeeff] to-transparent" />
          </div>
