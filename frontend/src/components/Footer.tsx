...
const FOOTER_LINKS = {
  services: [
    ...
    { label: 'Check E-Challan by State', href: '/e-challan' },
  ],
  cities: [
    { label: 'Delhi', href: '/delhi/challan-settlement' },
    { label: 'Noida', href: '/noida/challan-settlement' },
    { label: 'Gurgaon', href: '/gurgaon/challan-settlement' },
    { label: 'Ghaziabad', href: '/ghaziabad/challan-settlement' },
    { label: 'Faridabad', href: '/faridabad/challan-settlement' },
  ],
  support: [
    { label: 'FAQ', href: '/faq' },
